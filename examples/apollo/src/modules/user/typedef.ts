...
import {  ExtensionA, ExtensionB, Extensions } from "@baeta/core/sdk/extension";
...
export namespace ModuleMetadata {
  ...
  export function createManager(module: Baeta.ModuleBuilder<(typeof extensions)[number]>) {
    return {
      ...module.createModuleMethods<Types.ContextType>(),
      User: {
        ...module.createTypeMethods<User, Types.ContextType>("User"),
        ...module.getTypeExtensions<User, Types.ContextType>("User"),
...
export const createUserModule = () => Baeta.createModuleManager(ModuleMetadata, extensions);
