...
**Flexible**:
Add only what you need — extend functionality with optional build-time plugins, runtime app plugins, and libraries like:

- **@baeta/auth**: Granular scope-based authorization
- **@baeta/complexity**: Query complexity analysis to protect against expensive queries
