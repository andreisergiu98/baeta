...
export interface BaetaModuleTypes {
  Builders: {
    User: Baeta.TypeMethods<Types.User, Ctx, Info, "user-photos-pages", "User", BaetaModuleObjectTypeFields['User']['Builder'], BaetaModuleObjectTypeFields['User']['Factory']>
  };
  Factories: {
...
interface BaetaModuleObjectTypeFields {
  User: {
    Builder: {
      photosConnection: Baeta.FieldMethods<Types.UserPhotoConnection | null, Types.User, Ctx, Types.UserPhotosConnectionArgs, Info, "user-photos-pages", "User", "photosConnection">
    };
    Factory: {
...
export const UserPhotosPagesModule = Baeta.createModuleBuilder<Ctx, Info, "user-photos-pages", BaetaModuleTypes['Builders'], BaetaModuleTypes['Factories']>(moduleMetadata.id, moduleMetadata.typedef, {
  User: Baeta.createTypeBuilder("user-photos-pages", "User", {
    photosConnection: Baeta.createFieldBuilder("user-photos-pages", "User", "photosConnection", extensions)
  }, extensions)
}, {
