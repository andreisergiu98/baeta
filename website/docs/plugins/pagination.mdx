...
For a showcase of how to implement pagination with Prisma, check out the [pagination example](https://github.com/andreisergiu98/baeta/tree/main/examples/relay-pagination).
:::
