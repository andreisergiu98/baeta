...
import "./user-photos/user-photos-pages.resolvers.ts";

import "./user-photos/user-photos.resolvers.ts";

import {getBaetaDirectivesModule} from "./baeta-directives/typedef.ts";

import {getBaetaPaginationModule} from "./baeta-pagination/typedef.ts";
...
export const modules = [getBaetaDirectivesModule(), getBaetaPaginationModule(), getScalarsModule(), getUserPhotosModule(), getUserModule()];
