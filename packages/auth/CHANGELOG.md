...
- The auth package was renamed from `@baeta/extension-auth` to `@baeta/auth` and rewritten. The whole authorization model changed: by [@andreisergiu98](https://github.com/andreisergiu98) in [#290](https://github.com/andreisergiu98/baeta/pull/290)
