 ...
 * Source: https://github.com/marcduez/graphql-validation-directives/blob/main/src/valid-float-directive.ts
...
export const floatValidation: Definition = {
	sdl,
	directive,
};
