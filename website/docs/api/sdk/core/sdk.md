...
> **ScalarsMap** = `Record`\<`string`, [`ScalarResolver`](../../core/index-1.md#scalarresolver) \| `undefined`\>
...
> **TypeHashMap** = `Record`\<`string`, [`TypeHash`](#typehash) \| `undefined`\>
...
> **mergeMiddlewareMaps**(`target`, `source`): [`MiddlewareMap`](#middlewaremap)
