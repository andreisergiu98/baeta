...
export namespace ModuleMetadata {
  export const id = 'connections';
  export const dirname = './connections';
...
export const createConnectionsModule = () => Baeta.createModuleManager(ModuleMetadata, baetaExtensions);
export const getConnectionsModule = Baeta.createSingletonModule(createConnectionsModule);
