...
- [BuildFailure](interfaces/BuildFailure.md)
...
- [OnEndResult](interfaces/OnEndResult.md)
- [OnLoadArgs](interfaces/OnLoadArgs.md)
- [OnLoadOptions](interfaces/OnLoadOptions.md)
- [OnLoadResult](interfaces/OnLoadResult.md)
- [OnResolveArgs](interfaces/OnResolveArgs.md)
- [OnResolveOptions](interfaces/OnResolveOptions.md)
- [OnResolveResult](interfaces/OnResolveResult.md)
- [OnStartResult](interfaces/OnStartResult.md)
- [OutputFile](interfaces/OutputFile.md)
- [PartialMessage](interfaces/PartialMessage.md)
- [PartialNote](interfaces/PartialNote.md)
- [Plugin](interfaces/Plugin.md)
- [PluginBuild](interfaces/PluginBuild.md)
- [ResolveOptions](interfaces/ResolveOptions.md)
- [ResolveResult](interfaces/ResolveResult.md)
- [ServeOnRequestArgs](interfaces/ServeOnRequestArgs.md)
- [ServeOptions](interfaces/ServeOptions.md)
- [ServeResult](interfaces/ServeResult.md)
- [StdinOptions](interfaces/StdinOptions.md)
- [TransformFailure](interfaces/TransformFailure.md)
- [TransformOptions](interfaces/TransformOptions.md)
- [TransformResult](interfaces/TransformResult.md)
- [TsconfigRaw](interfaces/TsconfigRaw.md)
...
- [SameShape](type-aliases/SameShape.md)
...
- [analyzeMetafile](functions/analyzeMetafile.md)
- [analyzeMetafileSync](functions/analyzeMetafileSync.md)
- [build](functions/build.md)
- [buildSync](functions/buildSync.md)
- [context](functions/context.md)
- [formatMessages](functions/formatMessages.md)
- [formatMessagesSync](functions/formatMessagesSync.md)
- [initialize](functions/initialize.md)
- [stop](functions/stop.md)
- [transform](functions/transform.md)
- [transformSync](functions/transformSync.md)
